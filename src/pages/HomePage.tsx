      ...
      <main className={`flex-1 ${isLoaded ? 'page-fade-in' : 'opacity-0'}`}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-text-secondary max-w-3xl mx-auto">
                Designers create beautiful, modern layouts. Developers explain why they won't work
                in email. This tool shows you both perspectives.
              </p>
            </div>
        ...
        {/* <section id="cta-section" className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a
              href="/examples"
              className="inline-block bg-[var(--caribbean-current)] hover:brightness-90 !text-white font-semibold py-3 px-8 rounded-lg transition-colors"
            >
              View All Examples
            </a>
          </div>
