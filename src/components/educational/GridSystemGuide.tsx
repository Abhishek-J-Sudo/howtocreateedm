...
const GridLayout: React.FC<GridLayoutProps> = ({ title, description, columns, showOverlay, children }) => {
...
const GridCell: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className = "" }) => (
  <div className={`bg-bg-surface border border-border-subtle rounded p-4 flex items-center justify-center text-text-secondary text-sm font-medium ${className}`}>
    {children}
  </div>
);
  ...
  return (
    <div className="card p-8 mb-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-text-secondary">
            Think of your email design as a table with rows and columns. Here's how to structure common layouts.
          </p>
        </div>
      ...
      <div className="mb-8">
        ...
        <p className="text-text-secondary text-sm mb-6">Content-focused layout with image-text pairs for easy reading and engagement</p>
          ...
          <div className="relative bg-white border-2 border-border-default rounded-t-lg p-4 overflow-hidden">
            {showOverlays && (
              <div className="absolute inset-4 grid grid-cols-2 gap-2 pointer-events-none z-10">
                <div className="border-2 border-dashed border-blue-400 bg-blue-50/30 rounded flex items-center justify-center text-blue-600 font-mono text-xs">Header L</div>
                <div className="border-2 border-dashed border-blue-400 bg-blue-50/30 rounded flex items-center justify-center text-blue-600 font-mono text-xs">Header R</div>
              </div>
            )}
            <div className="grid grid-cols-2 gap-4 h-16">
              ...
              <div className="flex items-center justify-end space-x-4">
                <a href="#" className="text-sm hover:underline">Archive</a>
                <a href="#" className="text-sm hover:underline">Subscribe</a>
          ...
          <div className="relative bg-white border-2 border-border-default overflow-hidden rounded-lg">
            {showOverlays && (
              <div className="absolute inset-6 grid grid-rows-2 gap-2 pointer-events-none z-10">
                <div className="border-2 border-dashed border-indigo-400 bg-indigo-50/30 rounded flex items-center justify-center text-indigo-600 font-mono text-xs">Hero Image</div>
                <div className="border-2 border-dashed border-purple-400 bg-purple-50/30 rounded flex items-center justify-center text-purple-600 font-mono text-xs">Hero Content</div>
              </div>
            )}
            <div className="p-6">
              {/* Hero Image Row */}
              ...
              <div className="text-center">
                ...
                <p className="text-text-secondary text-lg mb-4 max-w-2xl mx-auto">
                  Your weekly dose of the latest developments in web development, design, and technology trends.
                </p>
          ...
          <div className="relative bg-white border-2 border-border-default p-6 overflow-hidden">
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
              {showOverlays && (
                <div className="absolute inset-6 grid grid-cols-2 gap-2 pointer-events-none z-10">
                  <div className="border-2 border-dashed border-green-400 bg-green-50/30 rounded flex items-center justify-center text-green-600 font-mono text-xs">Image L</div>
                  <div className="border-2 border-dashed border-blue-400 bg-blue-50/30 rounded flex items-center justify-center text-blue-600 font-mono text-xs">Content R</div>
                </div>
              )}
              ...
              <div>
                ...
                <p className="text-sm text-text-secondary mb-4">
                  Discover how artificial intelligence is transforming the way we build websites and applications. 
                  From automated code generation to intelligent design systems, AI is reshaping our industry.
                </p>
                <div className="bg-text-accent text-white text-sm px-4 py-2 rounded inline-block">Read More →</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 mb-8 relative">
              {showOverlays && (
                <div className="absolute inset-0 grid grid-cols-2 gap-2 pointer-events-none z-10">
                  <div className="border-2 border-dashed border-blue-400 bg-blue-50/30 rounded flex items-center justify-center text-blue-600 font-mono text-xs">Content L</div>
                  <div className="border-2 border-dashed border-green-400 bg-green-50/30 rounded flex items-center justify-center text-green-600 font-mono text-xs">Image R</div>
                </div>
              )}
              <div>
                <h3 className="text-lg font-bold mb-3">2025 Design Trends to Watch</h3>
                <p className="text-sm text-text-secondary mb-4">
                  Explore the latest design trends that are shaping user experiences across web and mobile platforms. 
                  From minimalism to bold typography choices that capture attention.
                </p>
                <div className="bg-text-accent text-white text-sm px-4 py-2 rounded inline-block">Read More →</div>
              </div>
              <div className="flex items-center justify-center">
            ...
            <div className="grid grid-cols-2 gap-6 relative">
              ...
              <div>
                ...
                <p className="text-sm text-text-secondary mb-4">
                  Learn essential techniques to improve your website's performance metrics and user experience. 
                  Speed matters more than ever in 2025 with Google's latest updates.
                </p>
                <div className="bg-text-accent text-white text-sm px-4 py-2 rounded inline-block">Read More →</div>
              </div>
            </div>
        ...
        <div className="relative bg-gray-50 border-2 border-border-default rounded-b-lg p-4 overflow-hidden">
          {showOverlays && (
            <div className="absolute inset-4 grid grid-cols-2 gap-2 pointer-events-none z-10">
              <div className="border-2 border-dashed border-purple-400 bg-purple-50/30 rounded flex items-center justify-center text-purple-600 font-mono text-xs">Footer L</div>
              <div className="border-2 border-dashed border-purple-400 bg-purple-50/30 rounded flex items-center justify-center text-purple-600 font-mono text-xs">Footer R</div>
            </div>
          )}
          <div className="grid grid-cols-2 gap-4">
            <div className="text-xs text-text-secondary">
              © 2025 TechNews. All rights reserved.<br/>
              123 Tech Street, San Francisco, CA 94105
            </div>
            <div className="text-right text-xs">
              <a href="#" className="text-text-accent hover:underline">Unsubscribe</a> | 
              <a href="#" className="text-text-accent hover:underline ml-1">Update Preferences</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-8">
        ...
        <p className="text-text-secondary text-sm mb-6">Product-focused layout with three-column showcase and strong CTA</p>
        ...
        <div className="mb-4">
          <div className="relative bg-white border-2 border-border-default rounded-t-lg p-4 overflow-hidden">
            {showOverlays && (
              <div className="absolute inset-4 grid grid-cols-2 gap-2 pointer-events-none z-10">
                <div className="border-2 border-dashed border-blue-400 bg-blue-50/30 rounded flex items-center justify-center text-blue-600 font-mono text-xs">Brand</div>
                <div className="border-2 border-dashed border-blue-400 bg-blue-50/30 rounded flex items-center justify-center text-blue-600 font-mono text-xs">Account</div>
              </div>
            )}
            <div className="grid grid-cols-2 gap-4 h-16">
              <div className="flex items-center">
          ...
          <div className="relative bg-white border-2 border-border-default p-6 overflow-hidden">
            {showOverlays && (
              <div className="absolute inset-6 grid grid-cols-3 gap-2 pointer-events-none z-10">
                <div className="border-2 border-dashed border-purple-400 bg-purple-50/30 rounded flex items-center justify-center text-purple-600 font-mono text-xs">Product 1</div>
                <div className="border-2 border-dashed border-purple-400 bg-purple-50/30 rounded flex items-center justify-center text-purple-600 font-mono text-xs">Product 2</div>
                <div className="border-2 border-dashed border-purple-400 bg-purple-50/30 rounded flex items-center justify-center text-purple-600 font-mono text-xs">Product 3</div>
              </div>
            )}
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="text-center">
                <div className="w-full h-32 bg-pink-100 rounded mb-3 flex items-center justify-center text-pink-600">Product Image</div>
              ...
              <div className="text-center">
                <div className="w-full h-32 bg-blue-100 rounded mb-3 flex items-center justify-center text-blue-600">Product Image</div>
              ...
              <div className="text-center">
                <div className="w-full h-32 bg-green-100 rounded mb-3 flex items-center justify-center text-green-600">Product Image</div>
        ...
        <div className="relative bg-gray-50 border-2 border-border-default rounded-b-lg p-4 overflow-hidden">
          {showOverlays && (
            <div className="absolute inset-4 grid grid-cols-2 gap-2 pointer-events-none z-10">
              <div className="border-2 border-dashed border-green-400 bg-green-50/30 rounded flex items-center justify-center text-green-600 font-mono text-xs">CTA</div>
              <div className="border-2 border-dashed border-orange-400 bg-orange-50/30 rounded flex items-center justify-center text-orange-600 font-mono text-xs">Support</div>
            </div>
          )}
          <div className="grid grid-cols-2 gap-4">
            <div className="text-center">
      ...
      <div className="mb-8">
        ...
        <p className="text-text-secondary text-sm mb-6">Single-column impact design with hero content and strong call-to-action</p>
        ...
        <div className="mb-4">
          <div className="relative bg-gradient-to-r from-orange-500 to-red-500 border-2 border-border-default rounded-t-lg p-4 overflow-hidden text-white">
            {showOverlays && (
              <div className="absolute inset-4 grid grid-cols-2 gap-2 pointer-events-none z-10">
                <div className="border-2 border-dashed border-yellow-300 bg-yellow-100/30 rounded flex items-center justify-center text-yellow-800 font-mono text-xs">Logo</div>
                <div className="border-2 border-dashed border-yellow-300 bg-yellow-100/30 rounded flex items-center justify-center text-yellow-800 font-mono text-xs">Offer</div>
              </div>
            )}
            <div className="grid grid-cols-2 gap-4 h-16">
              <div className="flex items-center">
            ...
            <div className="text-center relative z-10">
              ...
              <div className="mb-6 relative">
                ...
                <p className="text-lg text-text-secondary max-w-2xl mx-auto">
                  ...
                  Personal trainers, nutrition plans, and community support included.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-sm text-text-secondary">
                    ⏰ Offer expires in 48 hours | ✅ Cancel anytime | 🎯 30-day money-back guarantee
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="relative bg-gray-50 border-2 border-border-default rounded-b-lg p-4 overflow-hidden">
          {showOverlays && (
            <div className="absolute inset-4 grid grid-cols-1 gap-2 pointer-events-none z-10">
              <div className="border-2 border-dashed border-gray-400 bg-gray-100/30 rounded flex items-center justify-center text-gray-600 font-mono text-xs">Contact & Legal</div>
            </div>
          )}
          <div className="text-center">
            ...
            <div className="text-xs text-text-secondary">
              ...
              <a href="#" className="text-text-accent hover:underline ml-1">Privacy Policy</a> | 
              <a href="#" className="text-text-accent hover:underline ml-1">Unsubscribe</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-bg-elevated border border-border-subtle rounded-lg p-6 mt-8">
        <h4 className="font-semibold text-text-primary mb-4 flex items-center">
          ...
          Designer Tips for Email Grids
        </h4>
        
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <h5 className="font-medium text-text-primary mb-2">✅ Do This</h5>
            <ul className="space-y-2 text-sm text-text-secondary">
              <li>• Use fixed pixel widths (not percentages)</li>
              <li>• Keep total width between 600-650px</li>
              <li>• Plan for mobile: stack columns vertically</li>
              <li>• Leave padding/margins for spacing</li>
            </ul>
          </div>
          
          <div>
            <h5 className="font-medium text-text-primary mb-2">❌ Avoid This</h5>
            <ul className="space-y-2 text-sm text-text-secondary">
              <li>• Complex nested grids (keep it simple)</li>
              <li>• Flexbox or CSS Grid layouts</li>
              <li>• Overlapping elements</li>
              <li>• More than 3 columns on mobile</li>
            </ul>
          </div>
        </div>
      </div>
